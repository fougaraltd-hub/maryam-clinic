(function () {
  ...
  const I18N = {
    ar: {
      ...
      about:{
        h:"مريم مسعي-أحمد",
        body1:"أخصائية ومعالجة نفسية، حاصلة على ليسانس وماستر في علم النفس العيادي. تهتم بمجال الصحة النفسية وتسعى لمواصلة مسارها الأكاديمي في دكتوراه علم نفس الصحة، إيماناً منها بأهمية الربط بين الفهم العيادي العميق والتدخل العلاجي المتكامل.",
